...
// Order of prompts:
// 1. Grok (included Gemini Google Colab iterations, ran out of free prompts)
// 2. DeepSeek (include previous LaTeX context)
// 3. Claude (include all responses)
// 4. Gemini ()

// Order for tomorrow: DeepSeek, Claude, Grok, Gemini
